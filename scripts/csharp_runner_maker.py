...
def get_code(shellcode_fp, key):
    ...
    code = template % {'decryption_key': str(key),'encrypted_shellcode': to_csharp_array(encrypted_shellcode), 'decrypt_method': enc_utils.get_decrypt_method(Language.CSHARP)}
    print(code)
